...
define("lucky/dist/main-debug", [ "./data-debug", "./lucky-debug", "jquery-debug", "easing-debug", "./user-debug" ], function(require) {
    var data = require("./data-debug");
    var lucky = require("./lucky-debug");
    lucky.init(data);
});

define("lucky/dist/data-debug", [], [ "马云", "马化腾", "李彦宏", "周鸿祎", "玉伯", "沉鱼", "丹侠", "贯高", "邵帅", "陆辉", "南伯", "崔护", "偏右", "远尘", "臻儿", "左宜", "张初尘", "初成", "琼羽", "异草", "闭月", "周爱民", "陈皓", "winter", "army", "hax", "老赵", "sofish", "罗龙浩" ]);

define("lucky/dist/lucky-debug", [ "jquery-debug", "easing-debug", "./user-debug" ], function(require, exports, module) {
    var $ = require("jquery-debug");
    require("easing-debug");
...
define("lucky/dist/user-debug", [ "jquery-debug" ], function(require, exports, module) {
    var $ = require("jquery-debug");
